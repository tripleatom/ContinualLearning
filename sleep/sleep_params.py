"""Shared parameters for the sleep LFP / spectrogram pipeline.

Single source of truth imported by:
  - LFP_calculation.py       (NWB -> low_freq/*_lfp_traces.npz)
  - calculate_spectrogram.py (low_freq/*_lfp_traces.npz -> *_spectrograms.npz)
  - calculate_band_powers.py (lfp + spectrograms -> *_all_shanks_band_powers.pkl)
...
# =====================================================
# LFP PREPROCESSING  (LFP_calculation.py)
# =====================================================
preproc_params = {
    'reference': 'global',
    'operator': 'median',
...
# =====================================================
# SPECTROGRAM  (calculate_spectrogram.py)
# =====================================================
...
# =====================================================
# BAND POWERS  (calculate_band_powers.py)
# =====================================================
band_params = {
    'bands': {
        'delta': (0.5, 4),
...
# =====================================================
# BROADBAND ARTIFACT MASKING  (spectrogram_plot.py, Option B)
# =====================================================
...
# =====================================================
# CONSOLIDATED-SLEEP SEGMENTATION  (detect_sleep_periods.py, Stage 2)
# =====================================================
...
# =====================================================
# UP / DOWN STATE DETECTION  (detect_up_down.py, Stage 3)
# =====================================================
...
up_down_params = {
    ...
    'zoom_sec': 12,
    'zoom_offset_sec': 30,
    # Optional: path to a MUA pkl (from MUA.py) to use spike rate instead of the
