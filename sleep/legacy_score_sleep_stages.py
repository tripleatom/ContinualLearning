"""
legacy_score_sleep_stages.py
============================
Legacy, currently disconnected NREM / REM / Wake scoring pipeline.
...
for win in SLEEP_WINDOWS:
    ...
    if not bp_pkl.exists():
        ...
        print("       This legacy scorer requires its original band-power input schema.")
        continue
...
print(f"\n{'='*70}")
print("legacy_score_sleep_stages.py  DONE")
