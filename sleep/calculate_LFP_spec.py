...
# === CONFIGURATION ===
base_folder = r"\\10.129.151.108\xieluanlabs\xl_spinal_cord_electrode\CoI\CoI11\251103\3cms\data_251103_163841"
session_name = "data_251103_163841"  # Extracted from folder name
...
for shank_id in brain_shanks + spinal_shanks:
    ...
    lfp_data = rec_downsampled.get_traces(return_scaled=True) # Shape: (n_samples, n_channels)
    ...
    all_channel_info[shank_id] = {
        ...
        'channel_names': rec_downsampled.get_channel_ids().tolist(),
    }
