...
if __name__ == "__main__":
    ...
    proc_file = r"\\10.129.151.108\xieluanlabs\xl_cl\ephys\sleep\CnL39SG\front_camera_CnL39_2025-11-02_2_PROC"
    ...
    for idx, method in enumerate(methods):
        ...
        t, v, v_raw = compute_velocity(proc_file, method=method, window_length=11)
    ...
    t_adv, v_adv, vx_adv, vy_adv = compute_velocity_advanced(proc_file, window_length=11)
    ...
    plt.tight_layout()
    plt.savefig('velocity_advanced.png', dpi=150)
    plt.show()