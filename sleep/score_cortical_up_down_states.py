...
Hybrid design (per the user's choice):
  ...
  * LATER (MUA): set up_down_params['mua_pkl'] to a compute_sleep_mua.py output; the binned
...
from sleep_pipeline_config import (rec_folder, session_name, nwb_session_name,
...
stamp = (f"Generated {datetime.now():%Y-%m-%d %H:%M:%S} by score_cortical_up_down_states.py | "
